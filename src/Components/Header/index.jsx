...
import { colorPrimario } from "../../UIC/Variables";
...
const Logo = styled.img`
  ...
  width: 50px;
`
//usamos styled-components para los estilos de btn-primario y btn-secundario
const BtnHeader= styled.a`
  ...
  //Usamos props y operador ternario para diferenciar el color de cada boton
